			...
			?>
				...
				<footer class='container_wrap socket_color' id='socket' <?php avia_markup_helper(array('context' => 'footer')); ?>>
                    <div class='container'>
                        ...
                        <div class="socket-social-icons">
                            <?php if (ot_get_option('linkedin_link') !== '') : ?>
                                <a class="social-icon linkedin" href="<?php echo ot_get_option('linkedin_link'); ?>" target="_blank" title="Connect with us on LinkedIn">LinkedIn</a>
                            <?php endif; ?>
                            <?php if (ot_get_option('twitter_link') !== '') : ?>
                                <a class="social-icon twitter" href="<?php echo ot_get_option('twitter_link'); ?>" target="_blank" title="Follow us on Twitter">Twitter</a>
                            <?php endif; ?>
                            <?php if (ot_get_option('facebook_link') !== '') : ?>
                                <a class="social-icon facebook" href="<?php echo ot_get_option('facebook_link'); ?>" target="_blank" title="Find us on Facebook">Facebook</a>
                            <?php endif; ?>
                            <?php if (ot_get_option('googleplus_link') !== '') : ?>
                                <a class="social-icon googleplus" href="<?php echo ot_get_option('googleplus_link'); ?>" target="_blank" title="+1 us on Google+">Google+</a>
                            <?php endif; ?>
                        </div>
