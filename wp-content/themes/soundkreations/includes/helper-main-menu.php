...
<?php } ?>
		...
		<div  id='header_main' class='container_wrap container_wrap_logo'>
	        <div class="header-questions">
                <?php if (ot_get_option('question_page') !== '') : ?>
                    <a href="<?php echo ot_get_option('question_page'); ?>">
                        <img src="/wp-content/themes/soundkreations/img/btn_questions.png" alt="Questions?" />
                    </a>
                <?php endif; ?>
	        </div>
        <?php
